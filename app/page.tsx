  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <section className="border-t bg-muted/50">
        <div className="container mx-auto flex flex-col items-center justify-center gap-4 py-24 px-4 text-center">
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
            今すぐ始めましょう
          </h2>
      ...
      <footer className="border-t">
        <div className="container mx-auto flex flex-col gap-4 py-8 px-4 md:flex-row md:justify-between">
          <div className="flex items-center gap-2">
